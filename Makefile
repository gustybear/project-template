...
ifneq ($(COURSE_MATERIALS),)
	...
	find $(COURSE_DIR) -type f -maxdepth 1 -mindepth 1 -name '*.zsh' \
...
ifneq ($(COURSE_MATERIALS),)
	...
	find $(COURSE_DIR) -type -f -maxdepth 1 -mindepth 1 -name "inputs.mk" \
...
ifneq ($(COURSE_MATERIALS),)
	...
	find $(COURSE_DIR) -type -f -maxdepth 1 -mindepth 1 -name "inputs.mk.bak" \
