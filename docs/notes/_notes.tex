...
\newcommand{\lecture}[7]{
   ...
   \framebox{
      ...
      \vspace{4mm}
      \hbox to 6.28in { {\Large \hfill Lecture #4: #5  \hfill} }
      \vspace{2mm}
      \hbox to 6.28in { {\it Lecturer: #6 \hfill Scribes: #7} }
      \vspace{2mm}}
   }
   \end{center}
   \markboth{Lecture #4: #5}{Lecture #4: #5}

   {\bf Note}: {\it LaTeX template courtesy of UHM EE dept.}
...
%\lecture{**COURSE-NUMBER**}{**COURSE-NUMBER**}{**SEMESTER**}{**LECTURE-NUMBER**}{**DATE**}{**LECTURER**}{**SCRIBE**}
\lecture{course-number}{course-name}{semester}{0}{date}{lecturer-name}{scribe-name}
%\footnotetext{These notes are partially based on XXX.}
