...
\newcommand{\assignments}[8]{
   ...
   \framebox{
      ...
      \vspace{4mm}
      \hbox to 6.28in { {\Large \hfill Assignments #4 (Due: #5)  \hfill} }
      \vspace{4mm}
   ...
   \end{center}
   \markboth{Assignments #4 (Due: #5)}{Assignments #4 (Due: #5)}
...
\assignment{course number}{course name}{semester}{0}{due date}{\totalscore}{student name}{\today{last modified date}}

\problem{20}{\totalscore} .

\solution Your solution ...

\problem{40}{\totalscore} .
