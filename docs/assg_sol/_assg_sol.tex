...
\newcommand{\assignments}[6]{
   ...
   \framebox{
      ...
      \vspace{4mm}
      \hbox to 6.28in { {\Large \hfill Assignments #4: #5  \hfill} }
      \vspace{2mm}
      \hbox to 6.28in { {\it TA: #6 \hfill} }
      \vspace{2mm}}
   }
   \end{center}
   \markboth{Assignments #4: #5}{Assignments #4: #5}
...
%\assignments{**COURSE-NUMBER**}{**COURSE-NUMBER**}{**SEMESTER**}{**ASSIGNMENTS-NUMBER**}{**DATE**}{**TA**}
\assignments{course-number}{course-name}{semester}{0}{date}{ta-name}
