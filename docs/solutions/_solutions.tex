...
\newcommand{\solutions}[6]{
   ...
   \framebox{
      ...
      \vspace{4mm}
      \hbox to 6.28in { {\Large \hfill Solutions #4: #5  \hfill} }
      \vspace{2mm}
      \hbox to 6.28in { {\it TA: #6 \hfill} }
      \vspace{2mm}}
   }
   \end{center}
   \markboth{Solutions #4: #5}{Solutions #4: #5}
...
%\solutions{**COURSE-NUMBER**}{**COURSE-NUMBER**}{**SEMESTER**}{**ASSIGNMENTS-NUMBER**}{**DATE**}{**TA**}
\solutions{course-number}{course-name}{semester}{0}{date}{ta-name}
